...
-- 3. Temporarily change the statement delimiter to allow semicolons inside the procedure
DELIMITER $$                      
...
-- Verify triggers (optional, works in MySQL console)
SHOW TRIGGERS;

INSERT INTO employees(fname, lname, dept, salary) 
VALUES ('TEST', 'TEST', 'IT', -2500);
